...
# first_name = cohort_data[0]
# last_name = cohort_data[1]
# house = cohort_data[2]
# advisor = cohort_data[3]
# cohort = cohort_data[4]
# filename = open_file()
# print(filename)

def unique_houses(cohort_list):
	...
	# house_list = set()
	# for each_line in cohort_list:
	# 	house_list.add(each_line[2])
	# set_houses = set(house_list)
	# list_houses = list(set_houses)
	# list_houses.pop(0)
	# houses = set(list_houses)
	# return houses
